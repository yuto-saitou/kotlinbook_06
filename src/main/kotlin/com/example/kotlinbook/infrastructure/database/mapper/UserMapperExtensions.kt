 ...
 */
package com.example.kotlinbook.infrastructure.database.mapper

import com.example.kotlinbook.infrastructure.database.mapper.UserDynamicSqlSupport.User
import com.example.kotlinbook.infrastructure.database.mapper.UserDynamicSqlSupport.User.email
import com.example.kotlinbook.infrastructure.database.mapper.UserDynamicSqlSupport.User.id
import com.example.kotlinbook.infrastructure.database.mapper.UserDynamicSqlSupport.User.name
import com.example.kotlinbook.infrastructure.database.mapper.UserDynamicSqlSupport.User.password
import com.example.kotlinbook.infrastructure.database.mapper.UserDynamicSqlSupport.User.roleType
import com.example.kotlinbook.infrastructure.database.record.UserRecord
